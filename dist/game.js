(() => {
  ...
  var Bt = /* @__PURE__ */ __name(
    (e, r, t) => (r in e ? Nt(e, r, { enumerable: true, configurable: true, writable: true, value: t }) : (e[r] = t)),
    'Bt'
  );
    ...
    (e, r, t) =>
      new Promise((a, U) => {
        var S = /* @__PURE__ */ __name((V) => {
          ...
          D = /* @__PURE__ */ __name((V) => (V.done ? a(V.value) : Promise.resolve(V.value).then(S, v)), 'D');
  ...
  function ir(e, r, t) {
    ...
    let a = i(
        (A, L, H) => (
          H < 0 && (H += 1), H > 1 && (H -= 1), H < 1 / 6 ? A + (L - A) * 6 * H : H < 1 / 2 ? L : H < 2 / 3 ? A + (L - A) * (2 / 3 - H) * 6 : A
        ),
        'hue2rgb'
      ),
    ...
    return {
      ...
      mult(r) {
        ...
        for (let a = 0; a < 4; a++)
          for (let U = 0; U < 4; U++)
            t[a * 4 + U] =
              this.m[0 * 4 + U] * r.m[a * 4 + 0] +
              this.m[1 * 4 + U] * r.m[a * 4 + 1] +
              this.m[2 * 4 + U] * r.m[a * 4 + 2] +
              this.m[3 * 4 + U] * r.m[a * 4 + 3];
        return le(t);
      },
      multVec4(r) {
        return {
      ...
      multVec2(r) {
        return c(
          r.x * this.m[0] + r.y * this.m[4] + 0 * this.m[8] + 1 * this.m[12],
          r.x * this.m[1] + r.y * this.m[5] + 0 * this.m[9] + 1 * this.m[13]
        );
      },
      translate(r) {
      ...
      invert() {
        ...
        (r[0] = this.m[5] * t - this.m[6] * a + this.m[7] * U),
          (r[4] = -(this.m[4] * t - this.m[6] * S + this.m[7] * v)),
          (r[8] = this.m[4] * a - this.m[5] * S + this.m[7] * D),
          (r[12] = -(this.m[4] * U - this.m[5] * v + this.m[6] * D)),
          (r[1] = -(this.m[1] * t - this.m[2] * a + this.m[3] * U)),
          (r[5] = this.m[0] * t - this.m[2] * S + this.m[3] * v),
          (r[9] = -(this.m[0] * a - this.m[1] * S + this.m[3] * D)),
          (r[13] = this.m[0] * U - this.m[1] * v + this.m[2] * D),
          (r[2] = this.m[1] * V - this.m[2] * A + this.m[3] * L),
          (r[6] = -(this.m[0] * V - this.m[2] * H + this.m[3] * Y)),
          (r[10] = this.m[0] * ie - this.m[1] * H + this.m[3] * N),
          (r[14] = -(this.m[0] * L - this.m[1] * Y + this.m[2] * N)),
          (r[3] = -(this.m[1] * oe - this.m[2] * J + this.m[3] * ue)),
          (r[7] = this.m[0] * oe - this.m[2] * y + this.m[3] * ye),
          (r[11] = -(this.m[0] * J - this.m[1] * y + this.m[3] * P)),
          (r[15] = this.m[0] * ue - this.m[1] * ye + this.m[2] * P);
  ...
  i(De, 'testLineLine');
  function at(e, r) {
    return Te(e, r.p1) || Te(e, r.p2)
      ? true
      : !!De(r, mt(e.p1, c(e.p2.x, e.p1.y))) ||
          !!De(r, mt(c(e.p2.x, e.p1.y), e.p2)) ||
          !!De(r, mt(e.p2, c(e.p1.x, e.p2.y))) ||
          !!De(r, mt(c(e.p1.x, e.p2.y), e.p1));
  }
  __name(at, 'at');
  i(at, 'testRectLine');
  function Te(e, r) {
  ...
  i(fr, 'testLineCircle');
  function Qe(e, r) {
    if ($e(r, e.p1) || $e(r, e.p2)) return true;
    for (let t = 0; t < r.length; t++) {
      let a = r[t],
        U = r[(t + 1) % r.length];
      if (De(e, { p1: a, p2: U })) return true;
    }
    return false;
  }
  __name(Qe, 'Qe');
  ...
  function Ot(e, r) {
    ...
    if (t === 'object' && a === 'object') {
      ...
      for (let v of U) {
        let D = e[v],
          V = r[v];
        if (!(typeof D == 'function' && typeof V == 'function') && !Ot(D, V)) return false;
      }
      return true;
    }
    return e === r;
...
`)
    ...
    function D(o, f, g = t.defTex, R = t.defShader, x = {}) {
      (g = g != null ? g : t.defTex),
        (R = R != null ? R : t.defShader),
        (g !== t.curTex || R !== t.curShader || !Ot(t.curUniform, x) || t.vqueue.length + o.length * Ke > yt || t.iqueue.length + f.length > yt) &&
          V(),
        (t.curTex = g),
        (t.curShader = R),
        (t.curUniform = x),
    ...
    function A() {
      e.clear(e.COLOR_BUFFER_BIT),
        r.background || T({ width: Ee(), height: ce(), quad: de(0, 0, (Ee() * xe()) / yr, (ce() * xe()) / yr), tex: t.bgTex }),
        (t.drawCalls = 0),
        (t.transformStack = []),
        (t.transform = le());
    }
    ...
    function T(o) {
      ...
      let f = o.width,
        g = o.height,
        x = Ge(o.origin || pt).scale(c(f, g).scale(-0.5)),
        E = o.quad || de(0, 0, 1, 1),
      ...
      ye(),
        ...
        D(
          [
            { pos: Pe(-f / 2, g / 2, 0), uv: c(o.flipX ? E.x + E.w : E.x, o.flipY ? E.y : E.y + E.h), color: C, opacity: O },
            { pos: Pe(-f / 2, -g / 2, 0), uv: c(o.flipX ? E.x + E.w : E.x, o.flipY ? E.y + E.h : E.y), color: C, opacity: O },
            { pos: Pe(f / 2, -g / 2, 0), uv: c(o.flipX ? E.x : E.x + E.w, o.flipY ? E.y + E.h : E.y), color: C, opacity: O },
            { pos: Pe(f / 2, g / 2, 0), uv: c(o.flipX ? E.x : E.x + E.w, o.flipY ? E.y : E.y + E.h), color: C, opacity: O },
          ],
          [0, 1, 3, 1, 2, 3],
          o.tex,
          o.shader,
    ...
    function _(o) {
      ...
      if (o.tiled) {
        ...
        o.width && o.height
          ? ((x.x = o.width / g), (x.y = o.height / R))
          : o.width
          ? ((x.x = o.width / g), (x.y = x.x))
          : o.height && ((x.y = o.height / R), (x.x = x.y)),
          T(se(ne({}, o), { scale: x.scale(o.scale || c(1)), tex: o.tex, quad: f, width: g, height: R }));
    }
    __name(_, '_');
    i(_, 'drawTexture');
    ...
    function X(o) {
      ...
      if (o.radius) {
        ...
        E = [
          ...
          c(f, C),
          c(f, g - C),
          ...z(c(f - C, g - C), C, C, 0, 90),
          c(f - C, g),
          c(C, g),
          ...z(c(C, g - C), C, C, 90, 180),
          c(0, g - C),
          c(0, C),
          ...z(c(C, C), C, C, 180, 270),
        ];
    ...
    function k(o) {
      ...
      if (!(f.length < 2))
        ...
        } else for (let g = 0; g < f.length - 1; g++) W(se(ne({}, o), { p1: f[g], p2: f[g + 1] }));
    }
    __name(k, 'k');
    i(k, 'drawLines');
    function q(o) {
    ...
    function F(o) {
      ...
      o.radiusX === 0 ||
        o.radiusY === 0 ||
        ae(
          se(ne({}, o), { pts: z(c(0), o.radiusX, o.radiusY, (f = o.start) != null ? f : 0, (g = o.end) != null ? g : 360, o.resolution), radius: 0 })
        );
    }
    __name(F, 'F');
    i(F, 'drawEllipse');
    ...
    function w(o) {
      ...
      for (; me < g.length; ) {
        ...
        `
`
          ? ((Z += j), (re = 0), (be = null), Me.push(fe), (fe = []))
          : (o.width ? re + O > o.width : false) &&
            ((Z += j), (re = 0), be != null && ((me -= fe.length - be), (ge = g[me]), (fe = fe.slice(0, be))), (be = null), Me.push(fe), (fe = [])),
          ge !==
            `
` && (fe.push(ge), (re += O), ge === ' ' && (be = fe.length)),
    ...
    function Ae() {
      if (r.width && r.height && r.stretch)
        ...
        (t.width = e.drawingBufferWidth / xe()),
          (t.height = e.drawingBufferHeight / xe()),
  ...
  function gr(e = {}) {
    ...
    let t = {
      ...
      a = { ArrowLeft: 'left', ArrowRight: 'right', ArrowUp: 'up', ArrowDown: 'down', ' ': 'space' },
      U = ['space', 'left', 'right', 'up', 'down', 'tab', 'f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 's'];
    e.width && e.height && !e.stretch
      ? ((t.canvas.width = e.width * t.scale), (t.canvas.height = e.height * t.scale))
      : ((t.canvas.width = t.canvas.parentElement.offsetWidth), (t.canvas.height = t.canvas.parentElement.offsetHeight));
    let S = ['outline: none', 'cursor: default'];
    e.crisp && (S.push('image-rendering: pixelated'), S.push('image-rendering: crisp-edges')),
      (t.canvas.style = S.join(';')),
    ...
    (t.isTouch = 'ontouchstart' in window || navigator.maxTouchPoints > 0),
      t.canvas.addEventListener('mousemove', (w) => {
        W() ? (t.mousePos = c(w.offsetX, w.offsetY).scale(1 / t.scale)) : (t.mousePos = c(w.offsetX, w.offsetY).scale(1 / t.scale)),
          (t.mouseDeltaPos = c(w.movementX, w.movementY).scale(1 / t.scale)),
          (t.isMouseMoved = true);
      });
    ...
    t.canvas.addEventListener('mousedown', (w) => {
      ...
      t.canvas.addEventListener('keydown', (w) => {
        ...
        U.includes(G) && w.preventDefault(),
          G.length === 1 && t.charInputted.push(w.key),
          G === 'space' && t.charInputted.push(' '),
          w.repeat ? ((t.isKeyPressedRepeat = true), (t.keyStates[G] = 'rpressed')) : ((t.isKeyPressed = true), (t.keyStates[G] = 'pressed'));
      }),
      ...
      let G = i((Re) => {
        ...
        (t.realTime = Ae),
          t.skipTime ||
            ...
            (t.fpsTimer += t.dt),
            t.fpsTimer >= 1 && ((t.fpsTimer = 0), (t.fps = Math.round(t.fpsBuf.reduce((ce, xe) => ce + xe) / t.fpsBuf.length)), (t.fpsBuf = []))),
          (t.skipTime = false),
          w();
        ...
        (t.charInputted = []),
          (t.isMouseMoved = false),
          (t.isKeyPressed = false),
          (t.isKeyPressedRepeat = false),
          (t.loopID = requestAnimationFrame(G));
      }, 'frame');
      ...
      return U(
        typeof T == 'string'
          ...
          : N(null, P).then((_) => {
              ...
              for (let k in T) {
                let q = T[k],
                  $ = { tex: _.tex, frames: Y(q.sliceX, q.sliceY, q.x / X, q.y / W, q.width / X, q.height / W), anims: q.anims };
                (a.sprites[k] = $), (z[k] = $);
              }
              return z;
            })
  ...
  function Mr(e, r, t = {}) {
    ...
    function S() {
      ...
      a.forEach((H, Y) => {
        ...
        e.drawRect({ pos: L, width: J.width, height: J.height, origin: 'botleft', color: I(0, 0, 0), opacity: N }),
          e.drawFmtText(J),
          (L.y -= J.height);
      });
    }
  ...
  var Es = i((e = {}) => {
      ...
      let s = new Map(),
        ...
        b = {
          ...
          use(l) {
            ...
            for (let m in l)
              if (!k.has(m)) {
                ...
                this[m] === void 0 &&
                  Object.defineProperty(this, m, { get: () => d[m], set: (M) => (d[m] = M), configurable: true, enumerable: true });
              }
            let p = i(() => {
              if (!!l.require) {
            ...
            this.exists()
              ? (l.add && l.add.call(this), l.load && _e(() => l.load.call(this)), p())
              : l.require &&
                d.cleanups.push(
                  this.on('add', () => {
                    p();
          ...
          is(l) {
            if (l === '*') return true;
            if (Array.isArray(l)) {
              for (let d of l) if (!this.c(d)) return false;
              return true;
      ...
      return {
        ...
        moveBy(...s) {
          ...
          if (this.solid && ((d = this.area) == null ? void 0 : d.shape) === 'rect') {
            ...
            me((m) => {
              ...
              let K = { p1: c(0), p2: c(h, b) },
                ...
                st = c(B.p2.x, B.p1.y),
                it = 0,
                jt = { right: { p1: ke, p2: Ie }, top: { p1: Ie, p2: Le }, left: { p1: Le, p2: st }, bottom: { p1: st, p2: ke } };
              for (let Ce in jt) {
                let Fe = jt[Ce];
          ...
          return (
            (this.pos.x += h),
            (this.pos.y += b),
            l && (this.trigger('collide', l.target, l), l.target.trigger('collide', this, ze(this, l.displacement.scale(-1)))),
            l
          );
        },
        move(...s) {
    ...
    function Lr(n = {}) {
      ...
      return {
        ...
        isColliding(b) {
          if (!b.area || !b.exists()) return false;
        ...
        worldArea() {
          ...
          let p = Ge(this.origin || ue),
            m = ((te = this.pos) != null ? te : c(0)).add(this.area.offset).sub(p.add(1, 1).scale(0.5).scale(b, l));
    ...
    function Fr(n, s = {}) {
      ...
      function b(d, p, m, M) {
        ...
        return (
          m && M
            ? ((B.x = m / (d.width * p.w)), (B.y = M / (d.height * p.h)))
            : m
            ? ((B.x = m / (d.width * p.w)), (B.y = B.x))
            : M && ((B.y = M / (d.height * p.h)), (B.x = B.y)),
          B
        );
      }
      __name(b, 'b');
      return (
        i(b, 'calcTexScale'),
        {
          ...
          update() {
            ...
            (h.timer += L() * this.animSpeed),
              h.timer >= 1 / h.speed &&
                ((h.timer = 0),
                d.from > d.to
                  ? (this.frame--, this.frame < d.to && (h.loop ? (this.frame = d.from) : (this.frame++, h.onEnd(), this.stop())))
                  : (this.frame++, this.frame > d.to && (h.loop ? (this.frame = d.from) : (this.frame--, h.onEnd(), this.stop()))));
          },
          play(d, p = {}) {
            ...
            h && this.stop(),
              (h = {
                name: d,
                timer: 0,
                loop: (B = (M = p.loop) != null ? M : m.loop) != null ? B : false,
                pingpong: (te = (K = p.pingpong) != null ? K : m.pingpong) != null ? te : false,
                speed: (Ie = (ke = p.speed) != null ? ke : m.speed) != null ? Ie : 10,
                onEnd: (Le = p.onEnd) != null ? Le : () => {},
              }),
              typeof m == 'number' ? (this.frame = m) : (this.frame = m.from),
              this.trigger('animPlay', d),
              this.trigger('animStart', d);
          },
          stop() {
            if (!h) return;
            let d = h.name;
    ...
    function Or(n, s = {}) {
      function u() {
        ...
        return (
          (this.width = l.width / (((m = this.scale) == null ? void 0 : m.x) || 1)),
          (this.height = l.height / (((M = this.scale) == null ? void 0 : M.y) || 1)),
          l
        );
      }
      __name(u, 'u');
        ...
        update() {
          ...
          if (u) {
            ...
            !u.exists() || te !== ke || Le < st || Ie > it
              ? (this.trigger('fall', u), (u = null), (h = null), (m = true))
              : h && u.pos && ((this.pos = this.pos.add(u.pos.sub(h))), (h = u.pos.clone()));
          }
          if (!u) {
            let B = this.move(0, s);
            if (B)
    ...
    function tn(n, ...s) {
      ...
      let u = y.on('updateStart', () => {
        (y.events = {}),
          (y.objEvents = { add: new he(), update: new he(), draw: new he(), destroy: new he() }),
          y.objs.forEach((h) => {
            h.stay || ve(h);
          }),
          (y.timers = new he()),
          (y.cam = { pos: vt(), scale: c(1, 1), angle: 0, shake: 0 }),
          (y.camMousePos = t.mousePos()),
          (y.camMatrix = le()),
          (y.layers = {}),
          (y.defLayer = null),
          (y.gravity = J),
    ...
    if ((Et(Ir), e.plugins && e.plugins.forEach(Et), e.global !== false)) for (let n in Xe) window[n] = Xe[n];
    let zt = 0;
    function kn() {
      return zt;
    }
    ...
    function an() {
      ...
      if (n === 1) (y.loaded = true), y.trigger('load');
        ...
        a.drawRect({ pos: c(0), width: U(), height: S(), color: I(0, 0, 0) }),
          a.drawRect({ pos: h, width: s, height: u, fill: false, outline: { width: 4 / a.scale() } }),
          a.drawRect({ pos: h, width: s * n, height: u });
      }
    }
    __name(an, 'an');
    i(an, 'drawLoadScreen');
    function un() {
      ...
      if (Q.inspect) {
        let b = /* @__PURE__ */ __name(function (l, d) {
          ...
          let M = a.fmtText({ text: d, font: u, size: 16, pos: m, color: I(255, 255, 255) }),
            B = M.width + m.x * 2,
            K = M.height + m.x * 2;
          l.x + B / p >= U() && a.pushTranslate(c(-B, 0)),
            l.y + K / p >= S() && a.pushTranslate(c(0, -K)),
            a.drawRect({ width: B, height: K, color: I(0, 0, 0), radius: 4, opacity: 0.8 }),
            a.drawFmtText(M),
            a.popTransform();
        }, 'b');
        i(b, 'drawInspectTxt');
...
`)
      ...
      if (Q.timeScale !== 1) {
        ...
        let s = 8,
          u = a.fmtText({ text: Q.timeScale.toFixed(1), font: v.fonts[A], size: 16, color: I(255, 255, 255), pos: c(-s), origin: 'botright' });
      ...
      Q.curRecording &&
        (a.pushTransform(),
        a.pushTranslate(0, S()),
        a.pushScale(1 / t.scale),
        a.pushTranslate(24, -24),
        a.drawCircle({ radius: 12, color: I(255, 0, 0), opacity: St(0, 1, t.time() * 4) }),
        a.popTransform()),
        Q.showLog && D.draw();
    }
    __name(un, 'un');
    return (
      ...
      t.run(() => {
        zt++,
          y.loaded
            ? ((y.camMousePos = y.camMatrix.invert().multVec2(t.mousePos())),
              y.trigger('input'),
  ...
  var player = add([sprite('alien'), scale(0.5), pos(20, 20), area(), body()]);
  var MOVE_SPEED = 200;
  keyDown('right', () => {
